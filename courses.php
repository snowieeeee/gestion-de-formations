...
<body>
	...
	<div class="super_container">
								...
								<div style="width:154px;" class="header_content_right ml-auto text-right">
									<div class="header_search">
										<div class="search_form_container">
											<form method="post" action="client/rechercherFormation.php" id="search_form"
												class="search_form trans_400">
												<input type="search" class="header_search_input trans_400"
													placeholder="Rechercher" name="nomFormation" required="required">
												<div class="search_button">
													<i class="fa fa-search" aria-hidden="true"><button type="submit"
															class="invisible"></button></i>
												</div>
											</form>
		...
		<div class="courses">
			<div class="container">
				<form class="form-inline my-2 my-lg-0 " method="get" action="client/rechercherFormation.php">
										...
										<span>
											<form method="POST" action="insertion.php">
												...
												<div class='course_mark course_free trans_200'>
													<!--<form method="POST" action="insertion.php">-->
													<input type="hidden" name="nomClient"
														value="<?= $_SESSION['utilisateur']->getFirstName(); ?>" />
													<input type="hidden" name="idClient"
														value="<?= $_SESSION['utilisateur']->Id; ?>" /> <!--ajoutée-->
													<input type="hidden" name="titreFormation"
														value="<?= $row['titre']; ?>" />
													<input type="hidden" name="idFormation" value="<?= $row['Id']; ?>" />
													<button style="margin-bottom: 11px;" type='submit' name='envoyer'>S'inscrire</button>
												</div>
