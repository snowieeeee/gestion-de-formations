...
<head>
    ...
    <title>Gérer vos plannings</title>
...
<body class="bg-light">
    ...
    <div class="container py-5" id="page-container">
            <div class="row">
                <div class="col-md-9">
                        <a href="../view/RF_dashboard.php" role="button" class="btn btn-primary">
                            Tableau de bord
                        </a>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="cardt rounded-0 shadow">
                    <div class="card-header bg-gradient bg-primary text-light">
                        <h5 class="card-title">Créer une planification</h5>
                    </div>
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    <label for="title" class="control-label">Formation</label>
                                    <input type="text" class="form-control form-control-sm rounded-0" name="title" id="title" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="formateur" class="control-label">Formateur</label>
                                    <input type="text" class="form-control form-control-sm rounded-0" name="formateur" id="formateur" required>
                                </div>
                                <div class="form-group mb-2">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm rounded-0" name="session" id="session" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="start_datetime" class="control-label">Heure de début</label>
                                    <input type="datetime-local" class="form-control form-control-sm rounded-0" name="start_datetime" id="start_datetime" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="end_datetime" class="control-label">Heure de fin</label>
...
<?php 
$schedules = $conn->query("SELECT id, title, formateur, description, session, start_datetime, end_datetime FROM planification");
$sched_res = [];
