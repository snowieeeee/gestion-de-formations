...
<div class="super_container">
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner">
								<ul class="main_nav">
									...
									<li><a href="../client/mesFormations.php">Mes formations</a></li>
							...
							<div class="header_content_right ml-auto text-right">
								...
								<!-- Hamburger -->
								<div class="user" style="margin-left: 38px;"><a href="../client/profil.php"><i class="fa fa-user"></i></a></div>
								<div class="user" style="margin-left: 10px;"><a href="controller/utilisateur-controller.php?action=deconnexion"><i class="fa fa-power-off"></i></a></div>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="../client/profil.php">Profil</a></li>
				<li class="menu_mm"><a href="controller/utilisateur-controller.php?action=deconnexion">Se déconnecter</a></li>
			</ul>
		</nav>
		<hr>
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="index1.html">Accueik</a></li>
				<li class="menu_mm"><a href="courses.html">Cours</a></li>
				<li class="menu_mm"><a href="instructors.html">Professeurs</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<h1 class="home_title">Apprendre les langues facilement</h1>
						<div class="home_button trans_200"><a href="#">Commencer</a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="register_form_container">
						<div class="register_form_title">Formations gratuites</div>
