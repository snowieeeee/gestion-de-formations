                ...
                <div class="modal-body rounded-0">
                    <div class="container-fluid">
                        <dl>                            
                            ...
                            <dt class="text-muted">Formateur</dt>
                            <dd id="formateur" class="fw-bold fs-4"></dd>
...
$schedules = $connection->query("SELECT * FROM planification where title = (SELECT nomFormation FROM paiement where nomClient = '$name' and status = '2')");
$sched_res = [];
